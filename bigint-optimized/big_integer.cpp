...
big_integer::big_integer(big_integer const &other) : size(other.size), sign(other.sign), bits(other.bits) {}

big_integer::big_integer(int a) {
    bits.push_back(std::abs(static_cast<int64_t>(a)));
    sign = a < 0;
    size = a == 0 ? 0 : 1;
}
